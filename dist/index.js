...
var ISOSaturdayCalendar = (function (_super) {
    __extends(ISOSaturdayCalendar, _super);
    function ISOSaturdayCalendar() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.weekDays = ["Sa", "Su", "Mo", "Tu", "We", "Th", "Fr"];
        return _this;
    }
    ISOSaturdayCalendar.prototype.getFirstWeekDayOfMonth = function (year, month) {
        return (_super.prototype.getFirstWeekDayOfMonth.call(this, year, month) + 2) % 7 || 7;
    };
    return ISOSaturdayCalendar;
}(calendar_1["default"]));
exports["default"] = ISOSaturdayCalendar;
...
angular.module("ion-datetime-picker").service("$ionDtpCalendarIsoSaturday", calendar_1["default"]);
